...
public class ScreenLineRenderer : MonoBehaviour {
    ...
    {
        start = cam.ScreenToViewportPoint(cam.WorldToScreenPoint(other.transform.position));
    }
    
    private void OnTriggerExit(Collider other)
    {
        end = cam.ScreenToViewportPoint(cam.WorldToScreenPoint(other.transform.position));
